...
3. Compile dist files (Development) :
    ...
    * Make your changes only in ./build Folder OR package.json OR ./dist/js/demo.js OR package-lock.json OR ./dist//pages/ OR ./docs OR in any html files which are necessary for contribution
